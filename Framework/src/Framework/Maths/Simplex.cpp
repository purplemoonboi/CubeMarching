...
namespace Engine
{
     ...
     *
     * This method is faster than using (INT32)std::floor(fp).
     *
     ...
     *
     * Note that making this an uint32_t[] instead of a UINT8[] might make the
    ...
    */
	...
	{
        const INT32 h = hash & 0x0F;  // Convert low 4 bits of hash code
