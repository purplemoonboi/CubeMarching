...
namespace Engine
{
	...
	ScopePointer<RenderTarget> RenderTarget::CreateShadowRT(const void* initData, UINT32 width, UINT32 height)
	{
		switch (RendererAPI::GetAPI())
		{
		case RendererAPI::Api::None: 	CORE_ASSERT(false, "Not a recognised api!");	return nullptr;
		...
		case RendererAPI::Api::Vulkan:	CORE_ASSERT(false, "Vulkan is not a supported api!");	return nullptr;
		case RendererAPI::Api::DX11:	CORE_ASSERT(false, "DirectX 11 is not a supported api!");	return nullptr;
		case RendererAPI::Api::DX12:	return CreateScope<D3D12RenderTarget>(initData, width, height);
		default:
			return nullptr;
		}
	}
