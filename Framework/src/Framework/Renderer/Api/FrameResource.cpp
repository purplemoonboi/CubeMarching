...
namespace Engine
{
	ScopePointer<FrameResource> FrameResource::Create(GraphicsContext* graphicsContext, UINT passCount, UINT materialBufferCount, UINT objectCount, UINT id)
	{
		switch(RendererAPI::GetAPI())
		{
			...
			case RendererAPI::Api::DX12:	return CreateScope<D3D12FrameResource>(graphicsContext, passCount, materialBufferCount, objectCount, id);
			default:
				return nullptr;
		}
	}
