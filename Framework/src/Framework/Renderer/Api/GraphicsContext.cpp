...
namespace Engine
{
	RefPointer<GraphicsContext> GraphicsContext::Create(HWND windowHandle, INT32 swapChainBufferWidth, INT32 swapChainBufferHeight)
	{
		switch (Renderer::GetAPI())
		{
			...
			case RendererAPI::Api::DX12:   return CreateRef<DX12GraphicsContext>(windowHandle, swapChainBufferWidth, swapChainBufferHeight);
